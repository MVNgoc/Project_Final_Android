...
INSERT INTO leaveform VALUES
(1, 'thanhson', 'đi chơi', 'đi chơi với gia đình', '2022-01-18', '2022-01-15', 'Đang đợi', '', '3'), 
(2, 'tankhai', 'xin nghỉ vì bệnh', 'em bị cúm nên phải nghỉ ạ', '2022-02-20', '2022-01-07', 'Chấp nhận', '', '6'), 
(3, 'trunghau', 'xin nghỉ vì đi chơi', 'hưởng tuần trăng mật', '2022-03-14', '2022-01-15', 'Từ chối', 'DoAnCuoiKi-HK1-2021-2022.pdf', '7'), 
(4, 'hungnghia', 'test covid', 'em đi test covid nhanh ạ', '2022-01-16', '2022-01-15', 'Đang đợi', '', '3'), 
(5, 'huyentrang', 'Đi ăn đám cưới', 'Đi ăn đám cưới của em họ em ạ', '2022-02-15', '2022-01-15', 'Đang đợi', '', '1'), 
(6, 'chanhdai', 'Đi đá banh', 'Đi đá giải', '2022-04-20', '2022-01-15', 'Đang đợi', '06_41900772_NgThanhduy.pdf', '1'), 
(7, 'maitrung', 'Đi về quê', 'Đi về quê ăn đám dỗ', '2022-02-12', '2022-01-01', 'Chấp nhận', '', '4'), 
(8, 'tramy', 'Bận', 'Đưa con em đi bệnh viện', '2022-01-18', '2022-01-15', 'Đang đợi', 'FILE_20211228_123739_2021 13th salary_PT.pdf', '1'), 
(9, 'huybao', 'Đi về quê', 'em về quê thăm gia đình', '2022-02-12', '2022-01-15', 'Đang đợi', '', '4');
